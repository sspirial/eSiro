...
customElements.define('esiro-account', EsiroAccount);
...
customElements.define('esiro-login', EsiroLogin);
customElements.define('esiro-vendor-dashboard', EsiroVendorDashboard);
